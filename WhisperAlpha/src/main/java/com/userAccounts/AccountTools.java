...
public class AccountTools {
    ...
    public boolean changePassword(User user, String password) throws Exception {
        this.mongoInterfaceAccounts.changeHash(user.getUserName(), Password.getSaltedHash(password));
        return true;
    }
}
